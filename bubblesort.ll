...
33:                                               ; preds = %20
  ...
  call void @swap(i32* noundef %37, i32* noundef %42)
  br label %43
...
define dso_local i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %4, i8* align 16 bitcast ([7 x i32]* @__const.main.arr to i8*), i64 28, i1 false)
  store i32 7, i32* %3, align 4
  %5 = getelementptr inbounds [7 x i32], [7 x i32]* %2, i64 0, i64 0
  %6 = load i32, i32* %3, align 4
  call void @bubbleSort(i32* noundef %5, i32 noundef %6)
  %7 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0))
  %8 = getelementptr inbounds [7 x i32], [7 x i32]* %2, i64 0, i64 0
  %9 = load i32, i32* %3, align 4
  call void @printArray(i32* noundef %8, i32 noundef %9)
  ret i32 0
}
